...
SELECT name FROM players ORDER BY salary LIMIT 50;
...
SELECT name FROM players WHERE salary=18000000;
...
SELECT name FROM players WHERE team_id=23 AND salary=390000;
